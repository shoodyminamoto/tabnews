...
export default function RunawayPage() {
  ...
  return (
    <div style={{display: 'flex', flexDirection: 'column', alignItems: 'start', justifyContent: 'start', height: '100vh', padding: '20px'}}>
      <h1>Goiaba?</h1>
      <div style={{position: 'relative', display: 'flex', gap: '20px'}}>
        <button id="runaway-btn" style={{position: 'relative', transition: 'top 0.5s, left 0.5s'}}>NÃO! 😖😖😖</button>
